...
def path_to_word(grid, path):
    """
    Add all of the letters in the path to a string
    """
...
def search(grid, dictionary):
    """
    Search through the paths to locate words by matching strings to
...
def main():
    """
    This the function that will run the whole project
    """
